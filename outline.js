  ...
  "categories": [
      ...
      "sections": [
        {
          ...
          "kps": [
            ...
            },
            {
              "code": "1.1.3",
              "name": "文件操作",
              "desc": "ls、cd、pwd、mkdir、rm、cp、mv、touch"
            },
            {
              "code": "1.1.4",
              "name": "文件查看",
              "desc": "cat、more、less、tail、head"
            },
            {
              "code": "1.1.5",
              "name": "Vim编辑",
        ...
        {
          "code": "1.2",
          "name": "进阶：Shell 脚本与系统优化",
          "kps": [
            {
              "code": "1.2.1",
              "name": "Shell基础",
              "desc": "变量、参数、管道、重定向、条件循环"
            },
            {
              "code": "1.2.2",
              "name": "高级文本",
        ...
        },
        {
          ...
          "kps": [
            ...
            },
            {
              "code": "3.3.2",
              "name": "配置故障",
              "desc": "hosts 错误、节点名错误、权限不足"
            },
            {
              "code": "3.3.3",
              "name": "界面故障",
              "desc": "无法登录、启动失败、告警不弹窗"
            },
            {
              "code": "3.3.4",
              "name": "平台数据故障",
    ...
    },
    {
      ...
      "sections": [
        ...
        {
          "code": "4.3",
          "name": "运维：SCADA 故障与系统保障",
          "kps": [
            {
              "code": "4.3.1",
              "name": "采集故障",
              "desc": "遥测不刷新、遥信不变位、通道断"
            },
            {
              "code": "4.3.2",
              "name": "控制故障",
            ...
            },
            {
              "code": "4.3.3",
              "name": "SCADA告警故障",
              "desc": "不上窗、误告警、漏告警、语音不播"
            },
            {
              "code": "4.3.4",
              "name": "系统故障",
              "desc": "SCADA 切换、主备切换、进程挂掉"
            },
            {
              "code": "4.3.5",
              "name": "画面故障",
        ...
        },
        {
          ...
          "kps": [
            ...
            },
            {
              "code": "5.3.4",
              "name": "告警服务故障",
              "desc": "isw_fault_client 未启动、进程崩溃"
            },
            {
              "code": "5.3.5",
              "name": "联动故障",
              "desc": "与 SCADA 不同步、信号不匹配"
            }
          ]
        }
      ]
        ...
        },
        {
          ...
          "kps": [
            ...
            },
            {
              "code": "6.2.3",
              "name": "网络参数",
              "desc": "线路、变压器、电抗、电阻、变比"
            },
            {
              "code": "6.2.4",
              "name": "潮流计算",
              "desc": "调度员潮流、负荷转供、供电路径"
            }
          ]
        },
        {
    ...
    },
    {
      ...
      "comment": "D6.0_脑图.pdf 未列；编号来自题库 8.1.* 反推。KP 名待补全。",
      "sections": [
        {
          "code": "8.1",
          "name": "交换机配置实操",
